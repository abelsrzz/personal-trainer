...
def build_planning_prompt(target_start: date, target_end: date, output_path: Path) -> str:
    return (
        ...
        "6. Cuando el atleta vuelva a correr, reintroduce la carga de impacto de forma progresiva: usa como default aproximadamente `+5%` de volumen semanal de running sobre la ultima semana realmente absorbida, salvo que el contexto obligue a mantener o reducir. No subas a la vez volumen e intensidad de running en una semana fragil.\n"
