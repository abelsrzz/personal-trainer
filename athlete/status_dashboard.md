...
- Ultimos 7 dias: `11.7 km`, `2` carreras, `0` exigentes, tirada larga `6.7 km`.
- Ultimos 28 dias: `87.5 km`, `12` carreras, media `21.9 km/sem`.
- Ritmo medio 7d: `7:18/km`, FC media `147.9`.
- Cambio vs 7 dias previos: `-46%`.
...
- `2026-W15`: `10.4 km`, `1` carreras, `0` exigentes, tirada `10.4 km`.
...
- `2026-W19`: `11.7 km`, `2` carreras, `0` exigentes, tirada `6.7 km`.
